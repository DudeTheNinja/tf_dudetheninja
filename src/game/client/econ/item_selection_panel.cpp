...
const char *g_szEquipSlotHeader[] = 
{
	...
	"#ItemSel_DTNHAT",		// LOADOUT_POSITION_DTNHAT,
	"#ItemSel_DTNSHIRT",		// LOADOUT_POSITION_DTNSHIRT,
	"#ItemSel_DTNPANTS",		// LOADOUT_POSITION_DTNPANTS,
	"#ItemSel_DTNACC",		// LOADOUT_POSITION_DTNACC,
};
