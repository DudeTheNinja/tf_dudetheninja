...
const char *GetRandomBotName( void )
{
	static const char *nameList[] =
	{
		...
		"Herobrine",
		"MACHINE",
		"Blorbus the Destroyer",
		"leafohh hard drive",
		"Federal Agent Outside House",
		"Pootis",
		"Kira Miki",
		"Trick or Treater",
		"Creeper? Aw man",
		...
		"STOP FIGHTING!!!",
		"f r e a k Fortress 2",
		"Titled DudeTheNinja Mod",
		"Faye",
		"Phoebe",
		"leg man",
		"LEG MAN 2: ARM LAD",
		...
		"Certified Scrap Squad Member",
		"Beep Boop Beep. Error.",
		"Mini-Maidbot",
		"Luna",
		...
		"rocket.prj",
		"dead body coordinates",
		"Drawing Tablet",
		"team carrier",
		"the fiendish londoner",
		"dustbowlfan29",
		"WrenchMaster2007",
		"Certified Robot Kisser",
		"yro'ue*",
		"unpleasant gradient",
		"HEY APPLE!",
		"Frog Fortress 2",
		"Uncannily Incredible",
		"The Flying Scotsman",
		"Really Useless Mercenary",
		"Shrimp Link",
		"Wub Up The Volume",
		"Canned Bread",
		"When The Underwear Is Sus",
		"Boingloings",
