...
enum loadout_positions_t
{
	...
	// dtnmod SPECIFIC loadout slot items
	LOADOUT_POSITION_DTNHAT,
	LOADOUT_POSITION_DTNSHIRT,
	LOADOUT_POSITION_DTNPANTS,
	LOADOUT_POSITION_DTNACC,
...
inline bool IsWearableSlot( int iSlot ) 
{
	return iSlot == LOADOUT_POSITION_HEAD
		...
		|| iSlot == LOADOUT_POSITION_DTNHAT
		|| iSlot == LOADOUT_POSITION_DTNSHIRT
		|| iSlot == LOADOUT_POSITION_DTNPANTS
		|| iSlot == LOADOUT_POSITION_DTNACC
		|| IsMiscSlot( iSlot )
		|| IsTauntSlot( iSlot );
}
