...
public:
	...
	int					GetCustomItemCount( )			{ return m_pCustomItems.Count(); }
	CEconItemView*		GetCustomItem( int iIndex )	{ return m_pCustomItems[iIndex]; }
...
private:
	...
	CUtlVector<CEconItemView*>	m_pCustomItems;
